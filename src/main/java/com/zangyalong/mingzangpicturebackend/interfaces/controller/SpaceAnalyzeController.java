...
import com.zangyalong.mingzangpicturebackend.application.service.SpaceAnalyzeApplicationService;
...
public class SpaceAnalyzeController {
    ...
    @Resource
    private SpaceAnalyzeApplicationService spaceAnalyzeService;
    ...
    public BaseResponse<SpaceUsageAnalyzeResponse> getSpaceUsageAnalyze(
        ...
        SpaceUsageAnalyzeResponse spaceUsageAnalyze = spaceAnalyzeService.getSpaceUsageAnalyze
                (spaceUsageAnalyzeRequest, loginUser);
    ...
    public BaseResponse<List<SpaceCategoryAnalyzeResponse>> getSpaceCategoryAnalyze(
        ...
        User loginUser = userService.getLoginUser(request);
        List<SpaceCategoryAnalyzeResponse> resultList = spaceAnalyzeService.getSpaceCategoryAnalyze(
                spaceCategoryAnalyzeRequest, loginUser);
